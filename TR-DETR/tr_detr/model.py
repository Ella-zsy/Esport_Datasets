...
from tr_detr.matcher import build_matcher
from tr_detr.transformer import build_transformer
from tr_detr.position_encoding import build_position_encoding
from tr_detr.misc import accuracy
from tr_detr.interaction.test_CQA import VSLFuser
import torchvision
...
class TRDETR(nn.Module):
    ...
    def __init__(self, transformer, position_embed, txt_position_embed, txt_dim, vid_dim,
                 ...
                 max_v_l=1000, span_loss_type="l1", use_txt_pos=False, n_input_proj=2, aud_dim=0, clip_len = 2):#75
